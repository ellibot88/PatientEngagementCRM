import { QueryParams, RequestOptions } from 'ryuu.js/dist/models/interfaces/request';
/**
 ...
 */
export declare function isVerifiedOrigin(origin: string): boolean;
/**
 ...
 */
export declare function getQueryParams(): QueryParams;
/**
 ...
 */
export declare function setFormatHeaders(headers: Record<string, string>, url: string, options?: RequestOptions): void;
/**
